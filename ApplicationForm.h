...
namespace ClientRegistration {
	...
	System::Windows::Forms::Button^  BtnP_Change;
	System::Windows::Forms::TextBox^  TxtP_RepearPassword;
	System::Windows::Forms::TextBox^  TxtP_NewPassword;
	System::Windows::Forms::TextBox^  TxtP_OldPassword;
	...
	System::Windows::Forms::TextBox^  TxtE6End;
	System::Windows::Forms::TextBox^  TxtE6Start;
	System::Windows::Forms::Label^  label13;
	System::Windows::Forms::TextBox^  TxtE5End;
	System::Windows::Forms::TextBox^  TxtE5Start;
	System::Windows::Forms::Label^  label12;
	System::Windows::Forms::TextBox^  TxtE4End;
	System::Windows::Forms::TextBox^  TxtE4Start;
	System::Windows::Forms::Label^  label11;
	System::Windows::Forms::TextBox^  TxtE3End;
	System::Windows::Forms::TextBox^  TxtE3Start;
	System::Windows::Forms::TextBox^  TxtE2End;
	System::Windows::Forms::TextBox^  TxtE2Start;
	System::Windows::Forms::Label^  label9;
	System::Windows::Forms::TextBox^  TxtE1End;
	System::Windows::Forms::TextBox^  TxtE1Start;
	System::Windows::Forms::Label^  label8;
	System::Windows::Forms::Button^  BtnE_Add;
	System::Windows::Forms::Button^  BtnE_Delete;
	System::Windows::Forms::Button^  BtnE_Modify;
	System::Windows::Forms::GroupBox^  GroupBox;
	System::Windows::Forms::TextBox^  TxtE_Login;
	System::Windows::Forms::TextBox^  TxtE_Name;
	System::Windows::Forms::TextBox^  TxtE_Surname;
	System::Windows::Forms::CheckBox^  ChbEEmployee;
	System::Windows::Forms::Label^  label7;
	System::Windows::Forms::Label^  label6;
	System::Windows::Forms::Label^  label5;
	System::Windows::Forms::Button^  BtnE_Search;
	System::Windows::Forms::TextBox^  TxtE_Search;
	System::Windows::Forms::Label^  label4;
	System::Windows::Forms::DataGridView^  DG_Users;
	System::Windows::Forms::TabPage^  tabPage1;
	System::Windows::Forms::Button^  BtnS_Add;
	System::Windows::Forms::Button^  BtnS_Modify;
	System::Windows::Forms::Button^  BtnS_Delete;
	System::Windows::Forms::GroupBox^  groupBox3;
	System::Windows::Forms::TextBox^  TxtS_Description;
	System::Windows::Forms::TextBox^  TxtS_Time;
	System::Windows::Forms::TextBox^  TxtS_Price;
	System::Windows::Forms::TextBox^  TxtS_Name;
	System::Windows::Forms::Label^  label17;
	System::Windows::Forms::Label^  label16;
	System::Windows::Forms::Label^  label15;
	System::Windows::Forms::Label^  label14;
	System::Windows::Forms::DataGridView^  DG_Service;
	System::Windows::Forms::Button^  button5;
	System::Windows::Forms::TextBox^  TxtS_Search;
	System::Windows::Forms::Label^  Event;
	System::Windows::Forms::TabPage^  tabPage4;
	System::Windows::Forms::TextBox^  TxtES_Surname;
	System::Windows::Forms::TextBox^  TxtES_Name;
	System::Windows::Forms::TextBox^  TxtES_Search;
	System::Windows::Forms::Label^  label23;
	System::Windows::Forms::Label^  label22;
	System::Windows::Forms::Label^  label21;
	System::Windows::Forms::DataGridView^  DGES_AddService;
	System::Windows::Forms::Label^  label20;
	System::Windows::Forms::DataGridView^  DGES_Services;
	System::Windows::Forms::Label^  label19;
	System::Windows::Forms::DataGridView^  DGES_Employees;
	System::Windows::Forms::Button^  BtnES_Search;
	System::Windows::Forms::Label^  label18;
	System::Windows::Forms::TabPage^  tabPage5;
	System::Windows::Forms::Button^  BtnC_Delete;
	System::Windows::Forms::GroupBox^  GB_Clients;
	System::Windows::Forms::MaskedTextBox^  TxtC_Zipcode;
	System::Windows::Forms::TextBox^  TxtC_City;
	System::Windows::Forms::Label^  label29;
	System::Windows::Forms::Label^  label30;
	System::Windows::Forms::TextBox^  TxtC_Number;
	System::Windows::Forms::Label^  label31;
	System::Windows::Forms::TextBox^  TxtC_Street;
    System::Windows::Forms::Label^  label32;
	System::Windows::Forms::TextBox^  TxtC_Phone;
	System::Windows::Forms::Label^  label28;
	System::Windows::Forms::TextBox^  TxtC_Email;
	System::Windows::Forms::Label^  label27;
	System::Windows::Forms::TextBox^  TxtC_Surname;
	System::Windows::Forms::Label^  label26;
	System::Windows::Forms::TextBox^  TxtC_Name;
	System::Windows::Forms::Label^  label25;
	System::Windows::Forms::Button^  BtnC_Modify;
	System::Windows::Forms::Button^  BtnC_Add;
	System::Windows::Forms::DataGridView^  DGClients;
	System::Windows::Forms::Button^  BtnC_Search;
	System::Windows::Forms::TextBox^  TxtC_Search;
	System::Windows::Forms::Label^  label24;
	System::Windows::Forms::TabPage^  tabPage6;
	System::Windows::Forms::Button^  BtnR_Add;
	System::Windows::Forms::Button^  BtnR_Modify;
	System::Windows::Forms::Button^  BtnR_Delete;
	System::Windows::Forms::Label^  label38;
	System::Windows::Forms::TextBox^  TxtRL_Termin;
	System::Windows::Forms::TextBox^  TxtRL_Service;
	System::Windows::Forms::TextBox^  TxtRL_Client;
	System::Windows::Forms::TextBox^  TxtR_Employee;
	System::Windows::Forms::TextBox^  TxtR_Client;
	System::Windows::Forms::TextBox^  TxtR_Service;
	System::Windows::Forms::Label^  label37;
	System::Windows::Forms::Label^  label36;
	System::Windows::Forms::MonthCalendar^  Calendar;
	System::Windows::Forms::GroupBox^  GBox_Hours;
	System::Windows::Forms::DataGridView^  DGR_Employee;
	System::Windows::Forms::Button^  BtnRE_Search;
	System::Windows::Forms::Label^  label35;
	System::Windows::Forms::DataGridView^  DGR_Client;
	System::Windows::Forms::Button^  BtnRC_Search;
	System::Windows::Forms::Label^  label34;
	System::Windows::Forms::DataGridView^  DGR_Service;
	System::Windows::Forms::Button^  BtnRS_Search;
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			// toolStrip1
			// 
			this->toolStrip1->BackColor = System::Drawing::Color::FromArgb(static_cast<System::Int32>(static_cast<System::Byte>(0)), static_cast<System::Int32>(static_cast<System::Byte>(64)),
			...
			this->toolStrip1->Size = System::Drawing::Size(786, 80);
			this->toolStrip1->TabIndex = 1;
			this->toolStrip1->Text = L"toolStrip1";
			// 
			// toolStripButton4
			// 
			this->toolStripButton4->Font = (gcnew System::Drawing::Font(L"Segoe UI", 11.25F, System::Drawing::FontStyle::Bold, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(238)));
			this->toolStripButton4->ForeColor = System::Drawing::SystemColors::Control;
			this->toolStripButton4->Image = (cli::safe_cast<System::Drawing::Image^>(resources->GetObject(L"toolStripButton4.Image")));
			this->toolStripButton4->ImageTransparentColor = System::Drawing::Color::Magenta;
			this->toolStripButton4->Margin = System::Windows::Forms::Padding(37, 1, 0, 2);
			this->toolStripButton4->Name = L"toolStripButton4";
			this->toolStripButton4->Size = System::Drawing::Size(96, 77);
			this->toolStripButton4->Text = L"Reservation";
			this->toolStripButton4->TextImageRelation = System::Windows::Forms::TextImageRelation::ImageAboveText;
			this->toolStripButton4->Click += gcnew System::EventHandler(this, &ApplicationForm::toolStripButton4_Click);
			// 
			// toolStripButton2
			// 
			this->toolStripButton2->Font = (gcnew System::Drawing::Font(L"Segoe UI Semibold", 11.25F, System::Drawing::FontStyle::Bold, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(238)));
			this->toolStripButton2->ForeColor = System::Drawing::SystemColors::ButtonHighlight;
			this->toolStripButton2->Image = (cli::safe_cast<System::Drawing::Image^>(resources->GetObject(L"toolStripButton2.Image")));
			this->toolStripButton2->ImageTransparentColor = System::Drawing::Color::Magenta;
			this->toolStripButton2->Margin = System::Windows::Forms::Padding(37, 1, 0, 2);
			this->toolStripButton2->Name = L"toolStripButton2";
			this->toolStripButton2->Size = System::Drawing::Size(64, 77);
			this->toolStripButton2->Text = L"Clients";
			this->toolStripButton2->TextImageRelation = System::Windows::Forms::TextImageRelation::ImageAboveText;
			this->toolStripButton2->Click += gcnew System::EventHandler(this, &ApplicationForm::toolStripButton2_Click);
			// 
			// toolStripButton3
			// 
			this->toolStripButton3->Font = (gcnew System::Drawing::Font(L"Segoe UI", 11.25F, System::Drawing::FontStyle::Bold, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(238)));
			this->toolStripButton3->ForeColor = System::Drawing::SystemColors::ControlLightLight;
			this->toolStripButton3->Image = (cli::safe_cast<System::Drawing::Image^>(resources->GetObject(L"toolStripButton3.Image")));
			this->toolStripButton3->ImageTransparentColor = System::Drawing::Color::Magenta;
			this->toolStripButton3->Margin = System::Windows::Forms::Padding(37, 1, 0, 2);
			this->toolStripButton3->Name = L"toolStripButton3";
			this->toolStripButton3->Size = System::Drawing::Size(88, 77);
			this->toolStripButton3->Text = L"Employees";
			this->toolStripButton3->TextImageRelation = System::Windows::Forms::TextImageRelation::ImageAboveText;
			this->toolStripButton3->Click += gcnew System::EventHandler(this, &ApplicationForm::toolStripButton3_Click);
			// 
			// toolStripButton5
			// 
			this->toolStripButton5->Font = (gcnew System::Drawing::Font(L"Segoe UI", 11.25F, System::Drawing::FontStyle::Bold, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(238)));
			this->toolStripButton5->ForeColor = System::Drawing::SystemColors::ButtonHighlight;
			this->toolStripButton5->Image = (cli::safe_cast<System::Drawing::Image^>(resources->GetObject(L"toolStripButton5.Image")));
			this->toolStripButton5->ImageTransparentColor = System::Drawing::Color::Magenta;
			this->toolStripButton5->Margin = System::Windows::Forms::Padding(37, 1, 0, 2);
			this->toolStripButton5->Name = L"toolStripButton5";
			this->toolStripButton5->Size = System::Drawing::Size(69, 77);
			this->toolStripButton5->Text = L"Services";
			this->toolStripButton5->TextImageRelation = System::Windows::Forms::TextImageRelation::ImageAboveText;
			this->toolStripButton5->Click += gcnew System::EventHandler(this, &ApplicationForm::toolStripButton5_Click);
			// 
			// toolStripButton6
			// 
			this->toolStripButton6->Font = (gcnew System::Drawing::Font(L"Segoe UI", 11.25F, System::Drawing::FontStyle::Bold, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(238)));
			this->toolStripButton6->ForeColor = System::Drawing::SystemColors::Control;
			this->toolStripButton6->Image = (cli::safe_cast<System::Drawing::Image^>(resources->GetObject(L"toolStripButton6.Image")));
			this->toolStripButton6->ImageTransparentColor = System::Drawing::Color::Magenta;
			this->toolStripButton6->Margin = System::Windows::Forms::Padding(37, 1, 0, 2);
			this->toolStripButton6->Name = L"toolStripButton6";
			this->toolStripButton6->Size = System::Drawing::Size(64, 77);
			this->toolStripButton6->Text = L"Work";
			this->toolStripButton6->TextImageRelation = System::Windows::Forms::TextImageRelation::ImageAboveText;
			this->toolStripButton6->Click += gcnew System::EventHandler(this, &ApplicationForm::toolStripButton6_Click);
			// 
			// toolStripButton1
			// 
			this->toolStripButton1->Font = (gcnew System::Drawing::Font(L"Segoe UI", 11.25F, System::Drawing::FontStyle::Bold, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(238)));
			this->toolStripButton1->ForeColor = System::Drawing::Color::White;
			this->toolStripButton1->Image = (cli::safe_cast<System::Drawing::Image^>(resources->GetObject(L"toolStripButton1.Image")));
			this->toolStripButton1->ImageTransparentColor = System::Drawing::Color::Magenta;
			this->toolStripButton1->Margin = System::Windows::Forms::Padding(37, 1, 0, 2);
			this->toolStripButton1->Name = L"toolStripButton1";
			this->toolStripButton1->Size = System::Drawing::Size(70, 77);
			this->toolStripButton1->Text = L"Settings";
			this->toolStripButton1->TextImageRelation = System::Windows::Forms::TextImageRelation::ImageAboveText;
			this->toolStripButton1->Click += gcnew System::EventHandler(this, &ApplicationForm::toolStripButton1_Click);
			// 
			// tabPage2
			// 
			...
			this->tabPage2->Size = System::Drawing::Size(771, 388);
			...
			this->tabPage3->Size = System::Drawing::Size(771, 388);
			...
			this->DG_Users->Size = System::Drawing::Size(445, 356);
			...
			this->tabPage1->Size = System::Drawing::Size(771, 388);
			...
			this->DG_Service->AutoSizeColumnsMode = System::Windows::Forms::DataGridViewAutoSizeColumnsMode::Fill;
			...
			this->tabPage4->Size = System::Drawing::Size(771, 388);
			...
			this->label21->Location = System::Drawing::Point(10, 191);
			...
			this->DGES_AddService->AutoSizeColumnsMode = System::Windows::Forms::DataGridViewAutoSizeColumnsMode::Fill;
			this->DGES_AddService->ColumnHeadersHeightSizeMode = System::Windows::Forms::DataGridViewColumnHeadersHeightSizeMode::AutoSize;
			this->DGES_AddService->Location = System::Drawing::Point(3, 207);
			this->DGES_AddService->Name = L"DGES_AddService";
			this->DGES_AddService->Size = System::Drawing::Size(382, 178);
			...
			this->label20->Location = System::Drawing::Point(390, 191);
			...
			this->DGES_Services->AutoSizeColumnsMode = System::Windows::Forms::DataGridViewAutoSizeColumnsMode::Fill;
			this->DGES_Services->ColumnHeadersHeightSizeMode = System::Windows::Forms::DataGridViewColumnHeadersHeightSizeMode::AutoSize;
			this->DGES_Services->Location = System::Drawing::Point(393, 207);
			this->DGES_Services->Name = L"DGES_Services";
			this->DGES_Services->Size = System::Drawing::Size(382, 178);
			...
			this->label19->Location = System::Drawing::Point(294, 31);
			...
			this->DGES_Employees->AutoSizeColumnsMode = System::Windows::Forms::DataGridViewAutoSizeColumnsMode::Fill;
			this->DGES_Employees->ColumnHeadersHeightSizeMode = System::Windows::Forms::DataGridViewColumnHeadersHeightSizeMode::AutoSize;
			this->DGES_Employees->Location = System::Drawing::Point(297, 50);
			this->DGES_Employees->Name = L"DGES_Employees";
			this->DGES_Employees->Size = System::Drawing::Size(468, 138);
			...
			this->tabPage5->Size = System::Drawing::Size(771, 388);
			...
			this->tabPage6->Size = System::Drawing::Size(771, 388);
			...
			// BtnR_Add
			// 
			this->BtnR_Add->BackColor = System::Drawing::Color::ForestGreen;
			this->BtnR_Add->Cursor = System::Windows::Forms::Cursors::Hand;
			this->BtnR_Add->FlatAppearance->BorderSize = 0;
			this->BtnR_Add->FlatStyle = System::Windows::Forms::FlatStyle::Flat;
			this->BtnR_Add->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 11.25F, System::Drawing::FontStyle::Bold, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(238)));
			this->BtnR_Add->Location = System::Drawing::Point(10, 349);
			this->BtnR_Add->Name = L"BtnR_Add";
			this->BtnR_Add->Size = System::Drawing::Size(152, 33);
			this->BtnR_Add->TabIndex = 22;
			this->BtnR_Add->Text = L"Add";
			this->BtnR_Add->UseVisualStyleBackColor = false;
			this->BtnR_Add->Click += gcnew System::EventHandler(this, &ApplicationForm::BtnR_Add_Click);
			// 
			// BtnR_Modify
			// 
			this->BtnR_Modify->BackColor = System::Drawing::Color::DarkOrange;
			this->BtnR_Modify->Cursor = System::Windows::Forms::Cursors::Hand;
			this->BtnR_Modify->Enabled = false;
			this->BtnR_Modify->FlatAppearance->BorderSize = 0;
			this->BtnR_Modify->FlatStyle = System::Windows::Forms::FlatStyle::Flat;
			this->BtnR_Modify->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 11.25F, System::Drawing::FontStyle::Bold, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(238)));
			this->BtnR_Modify->Location = System::Drawing::Point(88, 309);
			this->BtnR_Modify->Name = L"BtnR_Modify";
			this->BtnR_Modify->Size = System::Drawing::Size(74, 34);
			this->BtnR_Modify->TabIndex = 21;
			this->BtnR_Modify->Text = L"Modify";
			this->BtnR_Modify->UseVisualStyleBackColor = false;
			this->BtnR_Modify->Click += gcnew System::EventHandler(this, &ApplicationForm::BtnR_Modify_Click);
			// 
			// BtnR_Delete
			// 
			this->BtnR_Delete->BackColor = System::Drawing::Color::Maroon;
			this->BtnR_Delete->Cursor = System::Windows::Forms::Cursors::Hand;
			this->BtnR_Delete->Enabled = false;
			this->BtnR_Delete->FlatAppearance->BorderSize = 0;
			this->BtnR_Delete->FlatStyle = System::Windows::Forms::FlatStyle::Flat;
			this->BtnR_Delete->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 11.25F, System::Drawing::FontStyle::Bold, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(238)));
			this->BtnR_Delete->Location = System::Drawing::Point(9, 309);
			this->BtnR_Delete->Name = L"BtnR_Delete";
			this->BtnR_Delete->Size = System::Drawing::Size(73, 34);
			this->BtnR_Delete->TabIndex = 20;
			this->BtnR_Delete->Text = L"Delete";
			this->BtnR_Delete->UseVisualStyleBackColor = false;
			this->BtnR_Delete->Click += gcnew System::EventHandler(this, &ApplicationForm::BtnR_Delete_Click);
			// 
			// label38
			// 
			...
			this->Calendar->TitleBackColor = System::Drawing::Color::FromArgb(static_cast<System::Int32>(static_cast<System::Byte>(255)), static_cast<System::Int32>(static_cast<System::Byte>(128)),
				static_cast<System::Int32>(static_cast<System::Byte>(0)));
			...
			this->DGR_Employee->AutoSizeColumnsMode = System::Windows::Forms::DataGridViewAutoSizeColumnsMode::Fill;
			...
			this->DGR_Client->AutoSizeColumnsMode = System::Windows::Forms::DataGridViewAutoSizeColumnsMode::Fill;
			...
			this->DGR_Service->AutoSizeColumnsMode = System::Windows::Forms::DataGridViewAutoSizeColumnsMode::Fill;
			...
			this->tabControl1->Location = System::Drawing::Point(2, 80);
			this->tabControl1->Name = L"tabControl1";
			this->tabControl1->SelectedIndex = 0;
			this->tabControl1->Size = System::Drawing::Size(779, 414);
			...
			this->ClientSize = System::Drawing::Size(786, 492);
...
#pragma endregion
	...
	private: void Clean_TxtBox(Control^ Box){
		//definition function which cleans all textbox in Groupbox
...
private: void Show_Service(System::Windows::Forms::TextBox^ Field, System::Windows::Forms::DataGridView^ Net ){
	//Definition of a function that shows services
	//Function takes two arguments: 1.Name of service entered in the TextBox, 2.Name of DataGriedView which the data is displayed
	...
	private: void Template_TimeWork(int TimeStart){
		//Function that fills hours of work in GroupBox1
		array<TextBox^> ^T_start = { TxtE1Start, TxtE2Start, TxtE3Start, TxtE4Start, TxtE5Start, TxtE6Start }; //Create TextBox array start hours
		array<TextBox^> ^T_End = { TxtE1End, TxtE2End, TxtE3End, TxtE4End, TxtE5End, TxtE6End };//Create TextBox array end hours
		
		for (int i = 0; i < 6; i++){
			T_start[i]->Text = TimeStart+":00";    //  entering the initial working hours given by the user into the textbox
			T_End[i]->Text = TimeStart+8+":00";    //  assume that the work lasts 8 hours a day, so we add 8 hours to the opening hours
		}
	}
			
	private: void search_employees(System::Windows::Forms::TextBox^ Field, System::Windows::Forms::DataGridView^ Net){
		//Definition of a function that shows employees in DataGridView
		//Function takes two arguments: 1.Name of employee entered in the TextBox, 2.Name of DataGriedView which the data is displayed
		MySqlConnection^ LinkBase = gcnew MySqlConnection(Configuration);
		...
		try{
			...
			MessageBox::Show(Statement->Message); //show message in Messagebox
		}
		}
	private: void search_clients(System::Windows::Forms::TextBox^ Field, System::Windows::Forms::DataGridView^ Net){
		//Definition of a function that shows clients in DataGridView
		//Function takes two arguments: 1.Name of client entered in the TextBox, 2.Name of DataGriedView which the data is displayed
		MySqlConnection^ LinkBase = gcnew MySqlConnection(Configuration);
	...
	private: Void ShowServices(){
		//Definition of a function that shows Services in DataGridView
		//Function takes two arguments: 1.Name of service entered in the TextBox, 2.Name of DataGriedView which the data is displayed
		MySqlConnection^ LinkBase = gcnew MySqlConnection(Configuration);
		...
		DGES_Services->Columns[0]->Visible = false; //hide first column
	...
	int Day = Convert::ToInt16(Day_week->DayOfWeek);
				 ...
				 for (int i = Hour_start; i <Hour_stop; i++)
				 {
					 for (int minuts = 0; minuts < 60; minuts += 30){
						 ...
						 if (DataRead->HasRows){
							 FieldHours->BackColor = System::Drawing::Color::Green;
							 Service = DataRead->GetString("Name");
							 Client = DataRead->GetString("Surname");
							 FieldHours->Tag = DataRead->GetString("visits_id");
						 }
						 else{
							 Service = "";
							 Client = "";
...
private: System::Void BtnP_Change_Click(System::Object^  sender, System::EventArgs^  e) {
	...
	private: System::Void BtnE_Search_Click(System::Object^  sender, System::EventArgs^  e) {
		search_employees(TxtE_Search, DG_Users);// function call showing employees
		DG_Users->Columns[0]->Visible = false; //Hide the first column
	}
	...
	private: System::Void ChbEEmployee_CheckedChanged(System::Object^  sender, System::EventArgs^  e) {
		if (ChbEEmployee->Checked){    
			GroupBox1->Visible = true; //Hide all in DroupBox1
		}
		else
		{
			GroupBox1->Visible = false;//show all in DroupBox1
		}
		Clean_TxtBox(GroupBox1); //clear all text boxes in Group Box 1
	}
	private: System::Void BtnE_Add_Click(System::Object^  sender, System::EventArgs^  e) {
		...
		else
		{
			...
			LinkBase->Close();  // close the connection from the database
		}
		Show_Net(); //Show the grid after adding user data again
	}
	private: System::Void BtnE_Modify_Click(System::Object^  sender, System::EventArgs^  e) {
		...
		if (TxtE_Name->Text->Length < 3 || TxtE_Surname->Text->Length < 4 || TxtE_Login->Text->Length < 5){
			MessageBox::Show("Data isn't complete!");
		}
		else{
			Employee_Type();
		...
		Show_Net();//Show the grid after modyfication user data again
	}
	...
	private: System::Void BtnE_Delete_Click(System::Object^  sender, System::EventArgs^  e) {
		...
		else
		{
			...
			try{
				if (MessageBox::Show("Are you Soure ?", "Attention", MessageBoxButtons::YesNo, MessageBoxIcon::Question) ==
					...
					Order->CommandText = "DELETE FROM visits WHERE Users_id = " + id_Record + "; ";
					Order->ExecuteNonQuery();
					Order->CommandText = "DELETE FROM user_service WHERE user_id= " + id_Record + "; ";
					Order->ExecuteNonQuery();
		...
		Clean_TxtBox(GroupBox);//cleans all textbox in Groupbox
		ChbEEmployee->Checked = false;
		Show_Net();   //Show the grid after removing user data again
	}
private: System::Void button1_Click(System::Object^  sender, System::EventArgs^  e) {
	Template_TimeWork(7);  //after pressing the key, enter the working hours between 7 and 15 in the textbox
	}
private: System::Void button2_Click(System::Object^  sender, System::EventArgs^  e) {
	Template_TimeWork(8); //after pressing the key, enter the working hours between 8 and 16 in the textbox
}
private: System::Void button3_Click(System::Object^  sender, System::EventArgs^  e) {
	Template_TimeWork(9);//after pressing the key, enter the working hours between 9 and 17 in the textbox
}
private: System::Void button4_Click(System::Object^  sender, System::EventArgs^  e) {
	Template_TimeWork(10);//after pressing the key, enter the working hours between 10 and 18 in the textbox
}
private: System::Void button5_Click(System::Object^  sender, System::EventArgs^  e) {
	Show_Service(TxtS_Search, DG_Service); // function call showing services
}
...
private: System::Void BtnS_Delete_Click(System::Object^  sender, System::EventArgs^  e) {
	//Removing the service performed by the employee
		MySqlConnection^ LinkBase = gcnew MySqlConnection(Configuration);
		MySqlCommand^ Order = gcnew MySqlCommand();
		MySqlTransaction^ transaction;
		LinkBase->Open();
		...
		try{
			if (MessageBox::Show("Are you Soure ?", "Attention", MessageBoxButtons::YesNo, MessageBoxIcon::Question) ==
				System::Windows::Forms::DialogResult::Yes){
				Order->CommandText = "DELETE FROM visits WHERE Services_id = " + id_Record + "; ";
				Order->ExecuteNonQuery();
				Order->CommandText = "DELETE FROM user_service WHERE services_id = " + id_Record + "; ";
				Order->ExecuteNonQuery();
	...
	LinkBase->Close();
	Clean_TxtBox(groupBox3); //cleans all textbox in Groupbox
	Show_Service(TxtS_Search, DG_Service); //function call showing services
}
private: System::Void BtnES_Search_Click(System::Object^  sender, System::EventArgs^  e) {
	
	search_employees(TxtES_Search, DGES_Employees);//// function call showing services
	DGES_Employees->Columns[0]->Visible = false;  //Hide first column
}
private: System::Void DGES_Employees_CellClick(System::Object^  sender, System::Windows::Forms::DataGridViewCellEventArgs^  e) {
	//Search services that the employee perform
	if (e->RowIndex >= 0){
...
private: System::Void DGES_AddService_CellClick(System::Object^  sender, System::Windows::Forms::DataGridViewCellEventArgs^  e) {
	//Add the service performed by the employee
	if (e->RowIndex >= 0){
...
private: System::Void BtnC_Add_Click(System::Object^  sender, System::EventArgs^  e) {
	...
	search_clients(TxtC_Search, DGClients); //show all Clients data in DataGridView
}
...
private: System::Void BtnC_Delete_Click(System::Object^  sender, System::EventArgs^  e) {
		...
		try{
			if (MessageBox::Show("Are you Soure ?", "Attention", MessageBoxButtons::YesNo, MessageBoxIcon::Question) ==
				System::Windows::Forms::DialogResult::Yes){
				Order->CommandText = "DELETE FROM visits WHERE Clients_id = " + id_Record + "; ";
				Order->ExecuteNonQuery();
		...
		LinkBase->Close();
	Clean_TxtBox(GB_Clients); //cleans all textbox in Groupbox
	search_clients(TxtC_Search, DGClients); //show Clients Data in DataGriedView "DGCClients"
}
private: System::Void BtnC_Modify_Click(System::Object^  sender, System::EventArgs^  e) {
	
	//Modification data clients in database
	if (TxtC_Name->Text->Length < 3 || TxtC_Surname->Text->Length < 3){
		MessageBox::Show("Data is not complete");
	}
	else
...
private: System::Void BtnRS_Search_Click(System::Object^  sender, System::EventArgs^  e) {
	Show_Service(TxtR_Service, DGR_Service); //function call showing services
}
private: System::Void BtnRC_Search_Click(System::Object^  sender, System::EventArgs^  e) {
	search_clients(TxtR_Client, DGR_Client);
	DGR_Client->Columns[0]->Visible = false; //Hide first column
	DGR_Client->Columns["Modyfication"]->Visible = false; //hide
}
private: System::Void BtnRE_Search_Click(System::Object^  sender, System::EventArgs^  e) {
	search_employees(TxtR_Employee, DGR_Employee); // function call showing services
	DGR_Employee->Columns[0]->Visible = false; //Hide first column
}
private: System::Void DGR_Service_CellClick(System::Object^  sender, System::Windows::Forms::DataGridViewCellEventArgs^  e) {
	if (e->RowIndex >= 0){
		...
		// displayy Employess who make this service
		MySqlConnection^ LinkBase = gcnew MySqlConnection(Configuration);
		MySqlCommand^ question = gcnew MySqlCommand("SELECT users.User_ID, users.Name, users.Surname, users.User_Name as Login, users.Employee FROM users, user_service WHERE users.User_ID = user_service.user_id AND user_service.services_id =" + id_Service+ " AND users.Employee = 1 ORDER BY Surname;", LinkBase);
		try{
			LinkBase->Open();
			MySqlDataAdapter^ MyData = gcnew MySqlDataAdapter();
			MyData->SelectCommand = question;
			...
			BindingSource^ Source = gcnew BindingSource();
			Source->DataSource = Tabel;
			DGR_Employee->DataSource = Source;
			LinkBase->Close();
		}
		catch (Exception^ Statement){
			MessageBox::Show(Statement->Message);
...
private: System::Void Field_Click(System::Object^  sender, System::EventArgs^  e) {
	...
	/////////////////////////////////////////////////////////////
	id_Visits = Convert::ToInt16(Field->Tag);
	MySqlConnection ^ LinkBase = gcnew MySqlConnection(Configuration);
	LinkBase->Open();
	MySqlCommand^ Question = gcnew MySqlCommand("SELECT CONCAT(clients.Name, ' ', clients.Surname) AS klient, visits.Clients_id, visits.Users_id, visits.Services_id, services.Name FROM visits, clients, services WHERE visits.visits_id = " + id_Visits + " AND clients.clients_id = visits.Clients_id AND services.services_id= visits.Services_id ;", LinkBase);
	MySqlDataReader^ DataRead;
	DataRead = Question->ExecuteReader();
	DataRead->Read();
	if (DataRead->HasRows){
		TxtRL_Client->Text = DataRead->GetString("klient");
		TxtRL_Service->Text = DataRead->GetString("Name");

		id_Service = DataRead->GetInt16("Services_id");
		id_Client = DataRead->GetInt16("Clients_id");
		id_Employee = DataRead->GetInt16("Users_id");
	}
	LinkBase->Close();
	if (Field->BackColor == System::Drawing::Color::Green){
		BtnR_Delete->Enabled = true;
		BtnR_Modify->Enabled = true;
	}
	else{
		BtnR_Delete->Enabled = false;
		BtnR_Modify->Enabled = false;
	}
}
private: System::Void Calendar_DateSelected(System::Object^  sender, System::Windows::Forms::DateRangeEventArgs^  e) {
	//Dateselect with calendar 
	DateSelect = String::Format(e->Start.ToShortDateString()); //gets data, converts to string, write to DateSelect
...
private: System::Void BtnR_Modify_Click(System::Object^  sender, System::EventArgs^  e) {
//////////////////////////////////////////////////////	
	//Modification Client reservation
	if (id_Client <= 0 || id_Service <= 0 || id_Employee <= 0 || TxtRL_Termin->Text->Length < 14){
	...
	else
	{
		...
		try{
			...
			Order->CommandText = "UPDATE Visits SET Clients_id = " + id_Client + ", Services_id =" + id_Service
				+ ", Users_id = " + id_Employee + ", Status = 'waiting' WHERE visits.visits_id ="+ id_Visits +";";
			Order->ExecuteNonQuery();
			transaction->Commit();
			MessageBox::Show("Reservation for Client has been modyfication :)");
		}
		catch (Exception^ Statement){
			MessageBox::Show(Statement->Message);
			transaction->Rollback();
...
private: System::Void BtnR_Delete_Click(System::Object^  sender, System::EventArgs^  e) {

	//Delete Client reservation with Base
	MySqlConnection^ LinkBase = gcnew MySqlConnection(Configuration);
	MySqlCommand^ Order = gcnew MySqlCommand();
	MySqlTransaction^ transaction;
	LinkBase->Open();
	...
	try{
		if (MessageBox::Show("Are you Soure ?", "Attention", MessageBoxButtons::YesNo, MessageBoxIcon::Question) ==
			System::Windows::Forms::DialogResult::Yes){
			Order->CommandText = "DELETE FROM visits WHERE visits_id = " + id_Visits + "; ";
			Order->ExecuteNonQuery();
			transaction->Commit();
			MessageBox::Show("Termin has been removed");
		}
	}
	catch (Exception^ Statement){
		MessageBox::Show(Statement->Message);
...
// These 6 below functions allow you to select the tabpage after clicking the image on the toolstrip
